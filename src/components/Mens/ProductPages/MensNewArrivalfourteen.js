  ...
  render () {
    return <div id='productstyling' >
      <main id='productspage'>
        <h6>Mens New</h6>
        <h4>Death Row Records Baseball Hat$29</h4>
        <div id='productleft'>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41389560_001_b?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41389560_001_d?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41389560_001_e?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <br />
        <div id='productright'>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41389560_001_f?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41389560_001_g?$medium$&defaultImage=' alt='' height='296px' width='197px' />
        </div>
        <aside id='rightside'>
          <div id='mrright'>
            <p id='p'>Death Row Records dad hat, bleached for a vintage vibe. Classic six-panel silhouette in cotton canvas features an embroidered logo at the front along with a curved brim, stitched grommets at the crown and an adjustable strapback closure. Complete with a bleach splatter finish that's done by hand, so each hat will be slightly unique.</p>
            <p id='p' />
          </div>
          <ul id='size'>
            <li id='sizes'>8</li>
