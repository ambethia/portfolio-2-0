  ...
  render () {
    return <div id='productstyling' >
      <main id='productspage'>
        <h6>Mens Shoes</h6>
        <h4>Asics Gel Lyte III Sneaker$120</h4>
        <div id='productleft'>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40396145_011_b?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40396145_011_d?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40396145_011_e?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <br />
        <div id='productright'>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40396145_011_f?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40396145_011_g?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40396145_011_h?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <aside id='rightside'>
          <div id='mrright'>
            <p id='p'>Ultra-cushy sneakers from Asics in a fresh colorway. Split-tongue design is rendered in soft leather with suede overlays + perforation detailing. Finished with a padded heel collar for increased stability, GEL cushioned midsole for maximum comfort and a grippy rubber outsole. With continued advancements in shoe technology and a dedication to classic silhouettes, Asics remains an innovator in style and sport.</p>
            <p id='p' />
          </div>
          <ul id='size'>
            <li id='sizes'>8</li>
