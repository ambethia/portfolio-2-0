  ...
  render () {
    return <div id='productstyling' >
      <main id='productspage'>
        <h6>Mens Shoes</h6>
        <h4>Vans Era Sneaker</h4>
        <div id='productleft'>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40841744_095_b?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40841744_095_d?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40841744_095_e?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <br />
        <div id='productright'>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40841744_095_f?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <aside id='rightside'>
          <div id='mrright'>
            <p id='p'>Rasta-inspired low top skate shoes from Vans. Slim sneaker with a double-stitched cotton canvas upper offers a padded tongue + lining for lightweight comfort. Finished with the brand's signature rubber waffle outsole. Favorites of skateboarders and surfers alike since 1966, sneakers and gear from SoCal legend Vans are still the epitome of cool.</p>
            <p id='p' />
          </div>
          <ul id='size'>
            <li id='sizes'>8</li>
