  ...
  render () {
    return <div id='productstyling' >
      <main id='productspage'>
        <h6>Mens Shoes</h6>
        <h4>Birkenstock Arizona Rubber EVA Sandal$35</h4>
        <div id='productleft'>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/33809104_001_b?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/33809104_001_d?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/33809104_001_e?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <br />
        <div id='productright'>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/33809104_001_f?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <aside id='rightside'>
          <div id='mrright'>
            <p id='p'>Waterproof EVA essential sandals from Birkenstock. Classic Arizona silhouette updated with EVA straps with adjustable buckle closures for a comfortable fit. Cushioned EVA molded footbed complete with an EVA textured outsole for optimal traction. Creators of the original contoured cork footbed, German label Birkenstock produces quality, iconic sandals and shoes with comfort and sustainability in mind.</p>
            <p id='p' />
          </div>
          <ul id='size'>
            <li id='sizes'>8</li>
