  ...
  render () {
    return <div id='productstyling' >
      <main id='productspage'>
        <h6>Mens Shoes</h6>
        <h4>Puma Ignite Limitless Hi-Tech Sneaker$130</h4>
        <div id='productleft'>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/42107771_001_b?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/42107771_001_d?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/42107771_001_e?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <br />
        <div id='productright'>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/42107771_001_f?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/42107771_001_g?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/42107771_001_h?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <aside id='rightside'>
          <div id='mrright'>
            <p id='p'>Live life at full speed in these freshly dropped runners from Puma's new Ignite Limitless Pack in partnership with The Weeknd. Breathable + waterproof upper is constructed from Kevlar-infused mesh with a PU-sealed toe, bonded TPU cage for additional durability and a reflective stretch bootie for a secure fit. Reflective midsole offers energy-returning IGNITE foam cushioning and a full-length carbon fiber TPU for extra support. Complete with a contrast rubber outsole for maximum traction. Puma is one of the world's leading sports brands designing + developing footwear, apparel + accessories.</p>
            <p id='p' />
          </div>
          <ul id='size'>
            <li id='sizes'>8</li>
