  ...
  render () {
    return <div id='productstyling' >
      <main id='productspage'>
        ...
        <h4>Dragon Ball Z Long Sleeve Tee$38</h4>
        <div id='productleft'>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41344037_001_b?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41344037_001_d?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41344037_001_e?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <br />
        <div id='productright'>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41344037_001_f?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41344037_001_g?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41344037_001_h?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <aside id='rightside'>
          <div id='mrright'>
            <p id='p'>Long sleeve t-shirt featuring a Dragon Ball Z graphic at the front and a text graphic down the left sleeve. Heavyweight cotton is cut in a standard fit and finished with rib-knit banding at the crew neck + cuffs.</p>
            <p id='p' />
          </div>
          <ul id='size'>
            <li id='sizes'>S</li>
        ...
        <div id='apartmentsale'>
          ...
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40895211_001_b?$medium$' alt='thejumpsuit' height='256px' width='171px' />
