  ...
  render () {
    return <div id='productstyling' >
      <main id='productspage'>
        <h6>Mens New</h6>
        <h4>Champion Coach Jacket</h4>
        <div id='productleft'>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/42039776_072_b?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/42039776_072_d?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/42039776_072_e?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <br />
        <div id='productright'>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/42039776_072_f?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/42039776_072_g?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/42039776_072_h?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <aside id='rightside'>
          <div id='mrright'>
            <p id='p'>Boldly bright coach jacket from Champion. Lightweight + durable nylon is cut in a slightly oversized silhouette with raglan sleeves, a pointed collar, full-length snap button front closure and an adjustable drawcord at the hem. Features embroidered C logo patches at the chest + left sleeve. Complete with waist pockets and elastic trim at the cuffs. Champion has been offering its innovative athletic apparel for men and women since 1919.</p>
            <p id='p' />
          </div>
          <ul id='size'>
            <li id='sizes'>S</li>
