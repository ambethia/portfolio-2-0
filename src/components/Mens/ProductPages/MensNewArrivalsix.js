  ...
  render () {
    return <div id='productstyling' >
      <main id='productspage'>
        <h6>Mens New</h6>
        <h4>Digital Mike Tyson Tee$28</h4>
        <div id='productleft'>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41973157_001_b?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41973157_001_d?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41973157_001_e?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <br />
        <div id='productright'>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41973157_001_f?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41973157_001_g?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41973157_001_h?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <aside id='rightside'>
          <div id='mrright'>
            <p id='p'>Classic Gazelles from adidas updated with colorful three-stripe detailing at the sides for a modern twist. Slim low cut silhouette in pigskin leather features synthetic overlays + lining along with a debossed trefoil logo at the tongue and contrast heel tab. Finished with a textured rubber outsole. One of the foremost sportswear labels worldwide, adidas combines fashion and function to create a classically technical range of sneakers and athletic wear.</p>
            <p id='p' />
          </div>
          <ul id='size'>
            <li id='sizes'>8</li>
