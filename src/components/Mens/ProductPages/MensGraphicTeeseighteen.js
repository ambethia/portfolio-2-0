  ...
  render () {
    return <div id='productstyling' >
      <main id='productspage'>
        ...
        <h4>Stussy Yin-Yang Hoodie Sweatshirt$68</h4>
        <div id='productleft'>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41866203_001_b?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41866203_001_d?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41866203_001_e?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <br />
        <div id='productright'>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41866203_001_f?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41866203_001_g?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/41866203_001_h?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <aside id='rightside'>
          <div id='mrright'>
            <p id='p'>Find balance in this Stussy hoodie featuring branded yin-yangs at the right sleeve + back. Soft cotton fleece is cut in a standard-fit pullover silhouette with an adjustable hood, front kanga pocket and rib-knit banding at the cuffs + hem. Stussy is a California-based label that delivers a collection of t-shirts, hoodies and accessories, all emblazoned with Shawn Stussy's iconic signature</p>
            <p id='p' />
          </div>
          <ul id='size'>
            <li id='sizes'>S</li>
