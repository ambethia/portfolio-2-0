  ...
  render () {
    return <div id='productstyling' >
      <main id='productspage'>
        <h6>Mens Shoes</h6>
        <h4>Vans Old Skool Suede Sneaker$55</h4>
        <div id='productleft'>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/30147854_001_b?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/30147854_001_d?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/30147854_001_e?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <br />
        <div id='productright'>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/30147854_001_f?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <aside id='rightside'>
          <div id='mrright'>
            <p id='p'>Essential skate sneakers from Vans. Soft suede uppers with contrast logo detailing at the sides topped with cotton laces and metal eyelets. Complete with a cushioned footbed and a padded ankle collar for added comfort. Finished with a vulcanized rubber midsole and a textured rubber sole for optimal traction.</p>
            <p id='p' />
          </div>
          <ul id='size'>
            <li id='sizes'>8</li>
