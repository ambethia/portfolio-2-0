  ...
  render () {
    return <div id='productstyling' >
      <main id='productspage'>
        ...
        <h4>Champion Big C Tee$28</h4>
        <div id='productleft'>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40301996_004_b?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40301996_004_d?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40301996_004_e?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <br />
        <div id='productright'>
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40301996_004_f?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
          <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40301996_004_g?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          <div>
            <img src='http://images.urbanoutfitters.com/is/image/UrbanOutfitters/40301996_004_h?$medium$&defaultImage=' alt='' height='296px' width='197px' />
          </div>
        </div>
        <aside id='rightside'>
          <div id='mrright'>
            <p id='p'>Get sporty in this classic t-shirt from Champion. Heathered cotton is cut in a standard fit and features a large C logo graphic at the chest. Complete with rib-knit banding at the crew neck and an embroidered logo patch at the left sleeve. Champion has been offering its innovative athletic apparel for men and women since 1919.</p>
            <p id='p' />
          </div>
          <ul id='size'>
            <li id='sizes'>S</li>
